...
public class Recorrido implements Dibujable {
	 ...
	 * 
	 * @param circuito
	 *            Recibe el circuito para calcular el recorrido
	 * @param coche
	 *            Recibe el coche para calcular el recorrido
	 * @param sentido
	 *            Recibe el sentido para calcular el recorrido
	 */
	...
	public void dibujar(Graphics g, int x, int y) {
		...
		g.drawArc(x, y, (int) ((radio * 2) * pixelsPorMetro), (int) (radio * 2 * pixelsPorMetro), 90, 180);
		g.drawArc((int) (x + ((longitudRecta) * pixelsPorMetro)), y, (int) ((radio * 2) * pixelsPorMetro),
				(int) (radio * 2 * pixelsPorMetro), 270, 180);
		g.drawLine((int) (x + ((radio) * pixelsPorMetro)), y, (int) (x + ((radio + longitudRecta) * pixelsPorMetro)),
				y);
